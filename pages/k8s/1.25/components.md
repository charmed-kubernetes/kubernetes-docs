...
<a class='p-button--brand' href='/kubernetes/charmed-k8s/docs/1.25/release-notes'>Release notes </a>
<a class='p-button--brand' href='/kubernetes/charmed-k8s/docs/1.25/upgrading'>Upgrading </a>
...
<!-- LINKS -->
[release notes]: /kubernetes/charmed-k8s/docs/release-notes#1.25
