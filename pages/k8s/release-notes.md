...
## Fixes
 ...
 - Added block storage config options ([Issue](https://github.com/juju-solutions/charm-openstack-integrator/pull/15))
 ...
 - Fixed client certs not having the requested common name ([Issue](https://github.com/juju-solutions/layer-easyrsa/pull/19))
 - Fixed create_client_cert never running ([Issue](https://github.com/juju-solutions/layer-easyrsa/pull/17))
 ...
 - Fixed etcd/0 Errored with 0 known peers ([Issue](https://github.com/juju-solutions/bundle-canonical-kubernetes/issues/702))
 ...
 - Fixed wrong name in requestheader-allowed-names ([Issue](https://github.com/juju-solutions/kubernetes/pull/217))
