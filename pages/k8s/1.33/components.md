...
which comprise the 1.33 release of Charmed Kubernetes.

Other information about this release can be found on the following pages:

<a class='p-button--brand' href='/kubernetes/docs/1.33/release-notes'>Release notes </a>
<a class='p-button--brand' href='/kubernetes/docs/1.33/upgrading'>Upgrading </a>
...
<a class='p-button--brand' href='https://launchpad.net/charmed-kubernetes/+milestone/1.33'>Milestone </a>
...
-  dns/k8s-dns-dnsmasq-nanny:1.25.0
-  dns/k8s-dns-kube-dns:1.25.0
-  dns/k8s-dns-sidecar:1.25.0
...
[release notes]: /kubernetes/docs/release-notes#1.33
[upgrade notes]: /kubernetes/docs/upgrade-notes
[bugs]: /kubernetes/docs/
[source]: https://github.com/charmed-kubernetes
[1.33 milestone]: https://launchpad.net/charmed-kubernetes/+milestone/1.33

<!-- FEEDBACK -->
<div class="p-notification--information">
  <div class="p-notification__content">
    <p class="p-notification__message">We appreciate your feedback on the documentation. You can
    <a href="https://github.com/charmed-kubernetes/kubernetes-docs/edit/main/pages/k8s/1.33/components.md" >edit this page</a>
    or
