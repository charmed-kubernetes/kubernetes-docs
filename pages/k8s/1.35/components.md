...
which comprise the 1.35 release of Charmed Kubernetes.

Other information about this release can be found on the following pages:

<a class='p-button--brand' href='/kubernetes/charmed-k8s/docs/1.35/release-notes'>Release notes </a>
<a class='p-button--brand' href='/kubernetes/charmed-k8s/docs/1.35/upgrading'>Upgrading </a>
...
<a class='p-button--brand' href='https://launchpad.net/charmed-kubernetes/+milestone/1.35'>Milestone </a>
...
[release notes]: /kubernetes/charmed-k8s/docs/release-notes#1.35
...
[1.35 milestone]: https://launchpad.net/charmed-kubernetes/+milestone/1.35

<!-- FEEDBACK -->
<div class="p-notification--information">
  <div class="p-notification__content">
    <p class="p-notification__message">We appreciate your feedback on the documentation. You can
    <a href="https://github.com/charmed-kubernetes/kubernetes-docs/edit/main/pages/k8s/1.35/components.md">edit this page</a>
    or
