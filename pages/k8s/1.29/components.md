...
<a class='p-button--brand' href='/kubernetes/charmed-k8s/docs/1.29/release-notes'>Release notes </a>
<a class='p-button--brand' href='/kubernetes/charmed-k8s/docs/1.29/upgrading'>Upgrading </a>
...
[release notes]: /kubernetes/charmed-k8s/docs/release-notes#1.29
