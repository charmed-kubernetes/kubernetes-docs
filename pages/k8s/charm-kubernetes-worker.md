...
You can run an action with the command:
...
evict existing pods.
      ...
      <table class ="u-table-layout--auto">
        ...
        <tbody>
             ...
             <tr>
               <td><pre>delete-local-data</pre></a></td>
      ...
      <table class ="u-table-layout--auto">
        ...
        <tbody>
            ...
            <td>base64 encoded htpasswd file used for authentication.
             ...
             <tr>
               <td><pre>htpasswd-plain</pre></a></td>
