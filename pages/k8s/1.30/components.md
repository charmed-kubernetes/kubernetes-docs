...
which comprise the 1.30 release of Charmed Kubernetes.

Other information about this release can be found on the following pages:

<a class='p-button--brand' href='/kubernetes/charmed-k8s/docs/1.30/release-notes'>Release notes </a>
<a class='p-button--brand' href='/kubernetes/charmed-k8s/docs/1.30/upgrading'>Upgrading </a>
...
<a class='p-button--brand' href='https://launchpad.net/charmed-kubernetes/+milestone/1.30'>Milestone </a>
...
-  dns/k8s-dns-dnsmasq-nanny:1.22.28
-  dns/k8s-dns-kube-dns:1.22.28
-  dns/k8s-dns-sidecar:1.22.28
...
-  metrics-server/metrics-server:v0.7.0
...
[release notes]: /kubernetes/charmed-k8s/docs/release-notes#1.30
...
[1.30 milestone]: https://launchpad.net/charmed-kubernetes/+milestone/1.30

<!-- FEEDBACK -->
<div class="p-notification--information">
  <div class="p-notification__content">
    <p class="p-notification__message">We appreciate your feedback on the documentation. You can
    <a href="https://github.com/charmed-kubernetes/kubernetes-docs/edit/main/pages/k8s/1.30/components.md" >edit this page</a>
    or
