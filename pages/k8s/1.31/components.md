...
which comprise the 1.31 release of Charmed Kubernetes.

Other information about this release can be found on the following pages:

<a class='p-button--brand' href='/kubernetes/charmed-k8s/docs/1.31/release-notes'>Release notes </a>
<a class='p-button--brand' href='/kubernetes/charmed-k8s/docs/1.31/upgrading'>Upgrading </a>
...
<a class='p-button--brand' href='https://launchpad.net/charmed-kubernetes/+milestone/1.31'>Milestone </a>
...
[release notes]: /kubernetes/charmed-k8s/docs/release-notes#1.31
...
[1.31 milestone]: https://launchpad.net/charmed-kubernetes/+milestone/1.31

<!-- FEEDBACK -->
<div class="p-notification--information">
  <div class="p-notification__content">
    <p class="p-notification__message">We appreciate your feedback on the documentation. You can
    <a href="https://github.com/charmed-kubernetes/kubernetes-docs/edit/main/pages/k8s/1.31/components.md" >edit this page</a>
    or
