...
| [kubernetes-dashboard](https://charmhub.io/kubernetes-dashboard) | A web-based Kubernetes user interface | [source](https://github.com/jnsgruk/kubernetes-dashboard-operator) | [docs](https://charmhub.io/kubernetes-dashboard/docs)  | [bugs](https://github.com/jnsgruk/kubernetes-dashboard-operator/issues) |
